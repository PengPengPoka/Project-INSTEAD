...
from PyQt5.QtCore import QTimer
from PyQt5.QtGui import QImage, QPixmap
from PyQt5.QtWidgets import QLabel, QVBoxLayout, QTabWidget, QFileDialog, QMessageBox, QInputDialog, QPushButton, QFrame, QGroupBox, QRadioButton, QWidget
from PyQt5.QtWidgets import QApplication, QMainWindow, QSlider, QLabel, QVBoxLayout, QPushButton, QWidget, QFileDialog
...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        uic.loadUi('/media/Backup/Teh/vision.ui', self)  # Replace 'vision.ui' with your UI file path
        self.initUI()
