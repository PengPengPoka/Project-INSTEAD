...
class ImageProcessor(QWidget):
    ...
    def __init__(self, ui_main_window):
        ...
        WEIGHT_PATH = BASE_DIR / "ml_utils" / "best_model.hdf5"
...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        vision = BASE_DIR / "utils" / "vision_revisi.ui"
    ...
    def initUI(self):
        ...
        self.path = BASE_DIR / "utils" / "default_param.txt"
    ...
    def execute_model(self):
        ...
        if hasattr(self, 'data_path'):
            ...
            script_path = BASE_DIR + "\\ml_utils\\model.py"
            subprocess.run(["python", script_path, "--image_path", self.data_path])
        else:
    ...
    def update_shot_count(self, file_name):
        BASE_DIR, file = os.path.split(file_name)
